...
<center>
	<h1 style="color: rgb(239, 239, 239); "">BATCH 2022</h1>
</center>
	...
	<div class="row">
		...
		<div class="col-lg-4">
			<div class="card p-0">
				...
				<div class="card-content d-flex flex-column align-items-center">
					<h4 class="pt-2">Ashish</h4>
					<h5 style="color: black; font-size: 12px; font-weight: bold">AMAZON</h5>
					<h2>11 LPA</h2>
